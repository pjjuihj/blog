---
title: "STM32示波器/信号发生器开发全记录"
date: 2026-07-02
draft: false
tags: ["stm32", "嵌入式", "FreeRTOS", "ADC", "DAC", "DMA", "示波器", "信号发生器"]
categories: ["项目开发"]
author: "pujj"
comments: true
summary: "用STM32F407做一个带示波器和信号发生器的小仪器，7天从零到功能完整。记录踩坑过程和调试经验。"
image: "https://picsum.photos/seed/scope-siggen/800/400"
---

## 项目概述

用 STM32F407 做一个带示波器和信号发生器功能的小仪器。7 天开发，从零到功能完整。
...
所有模块遵循统一接口：`Init/Start/Stop/GetStatus/SelfTest`。
...
- GitHub: [scope-siggen](https://github.com/pjjuihj/scope-siggen)
